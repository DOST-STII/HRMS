				...
				case 7:
					if(isset($dtr))
					{
							...
							if($dtr['wfh'] == null)
							{
								...
								{
									$rows =  "<tr><td style='width:10%'><span>".$i."</span><span style='float:right'>".$dayDesc."</span></td><td align='center' style='width:10%'></td><td align='center' style='width:10%'></td><td align='center' style='width:10%'></td><td align='center' style='width:10%'></td><td align='center' style='width:10%'></td><td align='center'></td><td align='center'></td><td align='center'>".$remarks."</td></tr>"; 
								}
		...
		if(!checkIfHasLeave($dt,$userid))
		{
			switch($list['wfh'])
			{
				...
				case "AM":
					...
					$rows = "<tr><td style='width:10%'><span>".$i."</span><span style='float:right'>".$dayDesc."</span></td><td align='center' colspan='2' class='text-success'><b>WFH</b></td><td align='center' colspan='2'>SKELETON WF</td><td></td><td></td><td></td><td></td><</tr>";
				break;
				...
				case "PM":
					...
					$rows = "<tr><td style='width:10%'><span>".$i."</span><span style='float:right'>".$dayDesc."</span></td><td align='center' colspan='2'>SKELETON WF</td><td align='center' colspan='2' class='text-success'><b>WFH</b></td><td></td><td></td><td></td><td></td><</tr>";
			   break;
			}
		}
		else
	...
	if($tos)
	{
		...
		switch($tos['to_deduction_time'])
		{
			...
			case "AM":
				...
				$rows = "<tr><td style='width:10%'><span>".$i."</span><span style='float:right'>".$dayDesc."</span></td><td align='center' colspan='2' class='text-success'><b>On-Trip</b></td><td colspan='2' align='center'>SKELETON WF</td><td></td><td></td><td></td><td></td><</tr>";
			break;
