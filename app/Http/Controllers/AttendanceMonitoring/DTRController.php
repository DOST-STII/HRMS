...
class DTRController extends Controller
{
    ...
    //     }
        ...
        $pdf->loadHTML('<!DOCTYPE html>
                            ...
                            <table width="100%" cellspacing="0" cellpadding="1" style="table-layout: fixed">
                                ...
                                <table width="100%" cellspacing="0" cellpadding="1" style="table-layout: fixed">
                                    <tr>
                                        <td style="width:90px"><b>Day</b></td><td style="width60px"><center><b>AM In</b></center>
                                        </td><td style="width:65px"><center><b>AM Out</b></center></td><td style="width:60px"><center><b>PM In</b></center></td>
                                        <td style="width:65px"><center><b>PM Out</b></center></td><td style="width:90px"><center><b>Total Hours</b></center></td>
                                        <td><center><b>Lates</b></center></td><td><center><b>Undertime</b></center></td><td><center><b>Deficit</b></center></td><td style="width:150px"><center><b>Remarks</b></center></td>
                                    </tr>
                                    <tbody>
                                        '.$rows.'
                               ...
                               if($i == $d2)
                                {
                                    ...
                                    //     return $dtr_date;
                                        ...
                                        //$tDaysDeficitTxt .= $tDaysDeficit." - ".$tDaysExcess.",";
                                        ...
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                if((($total_days - $lastWeekLeaves) - $lastTimeWeek) > 0)
                                                {
                                                    ...
                                                    // .= "totalDeficit : ".$totalDeficit."+ ((total_days : ".$total_days." - ".$lastWeekLeaves.") - lastTimeWeek : ".$lastTimeWeek.")";
                                                }
                            ...
                            <table width="100%" cellspacing="0" cellpadding="1" style="table-layout: fixed">
                                ...
                                <tr>
                                  <td style="border : 1px solid #FFF;font-size:12px">
                                        ...
                                        <b>Total Deficit : </b>'.readableTime($gDaysDeficit).'<br>
    ...
    public function cofinalprocesspayroll()
    {
        ...
        foreach ($proc as $key => $procs) {
            ...
            $other = getDeductionCOS($procs->user_id,'OTHER',request()->process_mon,request()->process_yr,request()->process_period,'num');
    ...
    public function printpayrollcos($mon,$yr,$period,$dt,$type = null,$charging = null)
    {
        ...
        foreach(getICOSProcess("101",$mon,$yr,$period,$dt) AS $divs)
        {
            ...
            //DEDUCTIONS
            $deductions = $itw + $hdmf + $pmpc + $other;
            ...
            if($header_ctr == 15)
            {
                ...
                <td style="width:12%"><b>Personnel</b></td>
                <td ><center><b>Division</b></center></td>
                <td style="width:8%"><center><b>Designation</b></center></td>
                ...
                <td><center><b>OTHER DEDUCTION</b></center></td>
            ...
            $row .= $hdead.'<tr>
                    <td>'.$staff['lname'].', '.ucwords(strtolower($staff['fname'].' '.substr($staff['mname'],0,1).'.')).'</td>
                    ...
                    <td align="right">'.formatCash($other).'</td>
        ...
        //GET STAFF 184
        foreach(getICOSProcess("184MOOE",$mon,$yr,$period,$dt) AS $divs)
        {
            //ORS
            $ors = getProcessInfoCOS($divs->user_id,$mon,$yr,$period,'ors');
            ...
            $text184MOOE .= convertTextCOSPayroll($divs->user_id,$staff['lname'],$staff['fname'],$staff['mname'],formatCash($net),$period);

            if($header_ctr == 15)
            {
                $hdead = '</table><div class="page-break"></div><center><h4><b>PAYMENT OF SALARIES OF 184(MOOE) PROJECT STAFF<br/>for the period '.$mon2.' '.$per.', '.$yr.'</b></h4></center><table width="100%" cellspacing="0" cellpadding="5" style="table-layout: fixed"><tr>
                <td style="width:12%"><b>Personnel</b></td>
                <td ><center><b>Division</b></center></td>
                <td style="width:8%"><center><b>Designation</b></center></td>
                <td><center><b>ORS No.</b></center></td>
            ...
            $row2 .= $hdead.'<tr>
                    <td>'.ucwords(strtolower($staff['lname'].', '.$staff['fname'].' '.substr($staff['mname'],0,1).'.')).'</td>
                    <td align="center">'.$div.'</td>
                    <td align="center">'.$pos.'</td>
                    <td align="center">'.$ors.'</td>
                    <td align="right">'.formatCash($salary).'</td>
        ...
        $tbl2 = '<center><h4><b>PAYMENT OF SALARIES OF 184(MOOE) PROJECT STAFF<br/>for the period '.$mon2.' '.$per.', '.$yr.'</b></h4></center>
        <table width="100%" cellspacing="0" cellpadding="5" style="table-layout: fixed">
            <tr>
                <td style="width:12%"><b>Personnel</b></td>
                <td ><center><b>Division</b></center></td>
        ...
        foreach(getICOSProcess("184",$mon,$yr,$period,$dt) AS $divs)
        {
            ...
            //DEDUCTIONS
            $deductions = $itw + $hdmf + $pmpc + $other;
            $total_deductions22 += $deductions;

            //WITHOUT PAY
            $withoutpay = ($salary / $totaldays) * $nodays;
            //$withoutpay = ceil($withoutpay * 100) / 100;
            $withoutpay = round($withoutpay,2);
            $total_wp22 += $withoutpay;
            ...
            $text184PS .= convertTextCOSPayroll($divs->user_id,$staff['lname'],$staff['fname'],$staff['mname'],formatCash($net),$period);

            if($header_ctr == 15)
            {
                $hdead = '</table><div class="page-break"></div><center><h4><b>PAYMENT OF SALARIES OF 184(PS) PROJECT STAFF<br/>for the period '.$mon2.' '.$per.', '.$yr.'</b></h4></center><table width="100%" cellspacing="0" cellpadding="5" style="table-layout: fixed"><tr>
                <td style="width:12%"><b>Personnel</b></td>
                <td ><center><b>Division</b></center></td>
                <td style="width:8%"><center><b>Designation</b></center></td>
                <td><center><b>ORS No.</b></center></td>
        ...
        $tbl22 = '<center><h4><b>PAYMENT OF SALARIES OF 184(PS) PROJECT STAFF<br/>for the period '.$mon2.' '.$per.', '.$yr.'</b></h4></center>
        <table width="100%" cellspacing="0" cellpadding="5" style="table-layout: fixed">
            <tr>
                <td style="width:12%"><b>Personnel</b></td>
                <td ><center><b>Division</b></center></td>
            ...
            '.$row22.'
                ...
                foreach(getICOSProcess("184C",$mon,$yr,$period,$dt) AS $divs)
                {
                    ...
                    $row3 .= $hdead.'<tr>
                            <td>'.$staff['lname'].', '.$staff['fname'].' '.substr($staff['mname'],0,1).'.'.'</td>
                            <td align="center">'.$div.'</td>
                            <td align="center">'.$pos.'</td>
                            <td align="center">'.$ors.'</td>
                            <td align="right">'.formatCash($salary).'</td>
            ...
            $pdf->loadHTML('<!DOCTYPE html>
                                ...
                                <body>
                                    ...
                                    <tr style="font-weight:bold">
                                        ...
                                        <td align="right">'.formatCash($total_other).'</td>
                                    ...
                                    <tr valign="top">
                                        <td style="border:0px solid #FFF">
                                            ...
                                            <b>ABEGAIL GRACE M. MARALIT</b><br>OIC - Accounting<br/><br/><br/><br/><br/>
                                    ...
                                    '.$tbl2.'
                                    <div class="page-break"></div>
                                    <center><h4><b>PAYMENT OF SALARIES OF 184(MOOE) PROJECT STAFF<br/>for the period '.$mon2.' '.$per.', '.$yr.'</b></h4></center>
                                    <table width="100%" cellspacing="0" cellpadding="5" style="table-layout: fixed">
                                    <tr>
                                        <td style="width:12%"><b>Personnel</b></td>
                                        <td ><center><b>Division</b></center></td>
                                    ...
                                    <tr style="font-weight:bold">
                                        ...
                                        <td align="right">'.formatCash($total_other2).'</td>
                                    ...
                                    '.$tbl22.'
                                    <div class="page-break"></div>
                                    <center><h4><b>PAYMENT OF SALARIES OF 184(PS) PROJECT STAFF<br/>for the period '.$mon2.' '.$per.', '.$yr.'</b></h4></center>
                                    <table width="100%" cellspacing="0" cellpadding="5" style="table-layout: fixed">
                                    <tr>
                                        <td style="width:12%"><b>Personnel</b></td>
                                        <td ><center><b>Division</b></center></td>
                                    ...
                                    <tr style="font-weight:bold">
                                        ...
                                        <td align="center"></td>
                                        <td align="center"></td>
                                        <td align="right">'.formatCash($total_salary22).'</td>
                                        <td align="center"></td>
                                        <td align="center"></td>
                                        <td align="center"></td>
                                        <td align="right">'.formatCash($total_wp22).'</td>
                                        <td align="right">'.formatCash($total_earned22).'</td>
                                        <td align="right">'.formatCash($total_itw22).'</td>
                                        <td align="right">'.formatCash($total_hdmf22).'</td>
                                        <td align="right">'.formatCash($total_pmpc22).'</td>
                                        <td align="right">'.formatCash($total_other22).'</td>
                                        <td align="right">'.formatCash($total_deductions22).'</td>
                                        <td align="right">'.formatCash($total_net22).'</td>
                                    </tr>
                                    </table>
                                    <br>
                                    <br>
                                    ...
                                    <tr style="font-weight:bold">
                                        ...
                                        <td align="right">'.formatCash($total_other3).'</td>
    ...
    public function printpcospayroll()
    {
        ...
        $earned = ($salary / $processdetail['daysmonth']) * ($processdetail['daysperiod']);

        //ITW
        $itw = $processdetail['itw'];
        if($itw == 0 || $itw == null)
            $itw = 0;
        else
        {
            $itw = ($earned - $withoutpay) * $itw;
            //$itw = ceil($itw * 100) / 100;
            $itw = round($itw,2);
        }

        //$itw = $earned * $processdetail['itw'];
        $totaldeduct = $itw + $processdetail['hdmf'] + $processdetail['pmpc'] + $withoutpay +  $processdetail['other'];
        ...
        $rows = '<div class="payslip">
                            <table width="100%" class="textLayer" cellspacing="0" cellpadding="2">
                                ...
                                <td style="border : 1px solid #FFF;width:15%" align="right">
                                    <img src="'.url('img/DOST.png').'" style="width:50px">
                                </td>
                                <td style="border : 1px solid #FFF;font-size:12px;" align="center">
                                        Republic of the Philippines<br/>
                                        PHILIPPINE COUNCIL FOR AGRICULTURE, AQUATIC AND NATURAL RESOURCES
                            ...
                            <table width="100%" class="textLayer" cellpadding="5" cellspacing="0">
                                <tr>
                                    <td colspan="3">
                                        <b>EMPLOYEE : </b> '.$fullname.'<br/>
                                        <b>DIVISION/POSITION : </b> '.getDivision(Auth::user()->division).' / '.getInfoCOS(Auth::user()->id,'position').'
                                        <br/>
                                        <br/>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width:20%;border:1px solid #999" align="center"><b>GROSS PAY</b></td>
                                    <td style="width:27%;border:1px solid #999" colspan="4" align="center"><b>DEDUCTIONS</b></td>
                                    <td style="width:20%;border:1px solid #999" align="center"><b>NET PAY</b></td>
                                </tr>
                                <tbody>
                                    <tr>
                                        <td valign="top" style="border:1px solid #999" align="right" rowspan="4">
                                            '.formatCash($earned).'
                                        </td>
                                        <td valign="top" style="border:1px solid #999">
                                            ABSENT/LATE/UNDERTIME
                                        </td>
                                        <td valign="top" style="border:1px solid #999" align="right">
                                            '.formatCash($withoutpay).'
                                        </td>
                                        <td valign="top" style="border:1px solid #999">
                                            HDMF
                                        </td>
                                        <td valign="top" style="border:1px solid #999" align="right">
                                            '.formatCash($processdetail['hdmf']).'
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top" style="border:1px solid #999" align="right">
                                            '.formatCash($processdetail['other']).'
                                        </td>
                                        <td valign="top" style="border:1px solid #999">
                                    ...
                                    <tr>
                                        <td style="border-top:1px solid #999;border-bottom:1px solid #999" colspan="2">
                                            <b>TOTAL DEDUCTIONS : </b><br/>
                                        </td>
                                        <td style="border-top:1px solid #999;border-bottom:1px solid #999" colspan="2" align="right">
                                            '.formatCash($totaldeduct).'<br/>
                                        </td>
                                    </tr>
                                    ...
                                    <tr valign="bottom">
                                        ...
                                        <br/>
                                        <br/>
                                        Certified by : <br/><br/><br/><u>&#160&#160&#160&#160&#160&#160&#160&#160&#160&#160&#160&#160&#160&#160&#160&#160&#160&#160&#160&#160&#160&#160&#160&#160&#160&#160&#160&#160&#160&#160&#160&#160&#160&#160&#160&#160&#160&#160&#160&#160&#160&#160&#160&#160&#160</u><br/><br/>
                                        Date Printed : '.Carbon::now().'</span></td>
                                    </tr>
