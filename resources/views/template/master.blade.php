...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-blue navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown" style="padding-top:5px">
        <span><b>{{ Auth::user()->fname }} {{ Auth::user()->lname }} &nbsp;&nbsp;</b></span>
      </li>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ url('/') }}" class="brand-link">
      <img src="{{ asset('login-page/images/logo.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      @elseif(Auth::user()->employment_id == 5 || Auth::user()->employment_id == 8)
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2023 DOST-STII <a href="#">HRMS</a>.</strong>
    All rights reserved.
