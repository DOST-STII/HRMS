                          ...
                          <div class="card card-primary card-outline card-outline-tabs">
                            ...
                            <div class="card-body">
                              <div class="tab-content" id="custom-tabs-three-tabContent">
                                ...
                                @if(checkStatusHRD($data['hrd_plan_id']))
                                      ...
                                      <tr><td colspan="15">A. Local</td></tr>
                                       ...
                                       @foreach($data['list_non_degree_foreign'] AS $lists)
                                          <tr>
                                            ...
                                            @if(!checkStatusHRD($data['hrd_plan_id']))
                                            <td><span class="fas fa-trash" style="color: red;cursor: pointer;" onclick="actionHRD('delete-non-degree',{{ $lists->id}})"></span></td>
                                            @endif
                                          </tr>
                                       @endforeach
                ...
                <div class="row" id="">
                    ...
                    <div class="col-md-12 option-hrd">
                      ...
                      <div class="form-group">
                          <select class="form-control" name="hrd_degree_staff" id="hrd_degree_staff">
                      ...
                      <div class="form-group-non-degree">xxarar
                      ...
                      <strong>Type</strong>
                      <div class="form-group">
                         <input type="radio" name="hrd_degree_type" value="Local"> Local &nbsp&nbsp
