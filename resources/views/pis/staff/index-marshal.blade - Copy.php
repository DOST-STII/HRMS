                      ...
                      <td align="center"><b>Staff</b></td>
                        ...
                        <?php
                          if($data['weeknum'] == 1)
                          {
                                  ...
                                  switch ($dayDesc) {
                                    case 'Tue':
                                        $d = '<td align="center" ><b>-</b></td><td align="center" style="cursor:pointer" class="text-primary" onclick="weeksched(1)"><b>1</b></td><td align="center" style="cursor:pointer" class="text-primary" onclick="weeksched(2)"><b>2</b></td><td align="center" style="cursor:pointer" class="text-primary" onclick="weeksched(3)"><b>3</b></td><td align="center" style="cursor:pointer" class="text-primary" onclick="weeksched(4)"><b>4</b></td>';
                                      break;
                      ...
                      <?php
                          if($data['weeknum'] == 1)
                          {
                            foreach(getAllStaffDivision4() AS $lists)
                            {
                              ...
                              if($lists->employment_id == 5)
                              {
                                $txtcolor = 'class="text-info"';
                              }

                              if($lists->employment_id == 15)
                              {
                                $txtcolor = 'class="text-danger"';
                              }
        ...
        <form method="POST" id="frm_sched" enctype="multipart/form-data" role="form" action="{{ url('dtr/weekly-schedule') }}">  
          ...
          <table class="table table-bordered">
            <thead>
              ...
              <th style="width: 15%;"><center>On-Trip</center></th>
              <th style="width: 15%;"><center>On-Leave</center></th>
            </thead>
          @foreach(getAllStaffDivision4() AS $lists)
                        <tr>
                            ...
                            <td align="center"><input type="radio" class="form-control-sm" name="dt_{{ $lists->id }}" value="On-Trip"></td>
                            <td align="center"><input type="radio" class="form-control-sm" name="dt_{{ $lists->id }}" value="On-Leave"></td>
                        </tr>
                      @endforeach
                    @if(Auth::user()->division == 'q' && Auth::user()->usertype == 'Marshal')
                      <tr>
                            ...
                            <td align="center"><input type="radio" class="form-control-sm" name="dt_141" value="On-Trip"></td>
                            <td align="center"><input type="radio" class="form-control-sm" name="dt_141" value="On-Leave"></td>
                        </tr>
                      @endif
          </table>
      </div>
...
<div class="modal" tabindex="-1" role="dialog" id="modalSchedAdd">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
        <form method="POST" id="frm_sched_add" enctype="multipart/form-data" role="form" action="{{ url('dtr/weekly-schedule-add') }}">  
          {{ csrf_field() }}
          <input type="hidden" name="sked_userid" id="sked_userid">
          <input type="hidden" name="sked_date" id="sked_date">
          <input type="hidden" id="sked_weeknum" name="sked_weeknum" value="{{ $data['weeknum'] }}">
          <input type="hidden" name="sked_mon" id="sked_mon" value="{{ $data['mon'] }}">
          <input type="hidden" name="sked_year" id="sked_year" value="{{ $data['yr'] }}">
        ...
        <p class="text-muted">
          ...
          <div class="icheck-primary d-inline" style="margin-right: 10px">
            <input type="radio" id="icoswholeday2" name="sched_add_status" value="WFH">
            <label for="icoswholeday2">
               WFH
            </label>
          </div>

          <div class="icheck-primary d-inline" style="margin-right: 10px">
            <input type="radio" id="icosam2" name="sched_add_status" value="Office">
            <label for="icosam2">
              OFFICE
            </label>
          </div>
          ...
          <div class="icheck-primary d-inline" style="margin-right: 10px">
            <input type="radio" id="icospm2" name="sched_add_status" value="Pickup">
            <label for="icospm2">
              OFFICE/PICKUP
            </label>
          </div>
          <div class="icheck-primary d-inline" style="margin-right: 10px">
            <input type="radio" id="icosontrip2" name="sched_add_status" value="On-Trip">
            <label for="icosontrip2">
              ON-TRIP
            </label>
          </div>

          <div class="icheck-primary d-inline" style="margin-right: 10px">
            <input type="radio" id="icosonleave2" name="sched_add_status" value="On-Leave">
            <label for="icosonleave2">
              ON-LEAVE
            </label>
          </div>
          <br/>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="button" class="btn btn-primary" onclick="addSchedSubmit()">Save changes</button>
      </div>
...
// });
  ...
  function weeksched(days)
    ...
    function addSched(userid,dt = null)
    {
      $("#sked_userid").val(userid);
      $("#sked_date").val(dt);
      $("#modalSchedAdd").modal("toggle");
    }

    function addSchedSubmit()
    {
      $("#overlay").show();
      $("#frm_sched_add").submit();
    }
</script>
@endsection