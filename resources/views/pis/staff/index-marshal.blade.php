    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" id="frm_sched" enctype="multipart/form-data" role="form" action="{{ url('dtr/weekly-schedule') }}">  
          ...
          <input type="hidden" id="weeksched_empid" name="weeksched_empid">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type="hidden" name="scheduserid" id="scheduserid" >
...
// });
  ...
  function showDTR()
  {
    ...
    window.location.replace("{{ url('home') }}/"+mon+"/"+yr+"/"+userid+"/"+weeknum);
  }
