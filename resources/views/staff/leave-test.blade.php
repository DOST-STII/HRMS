  ...
  <div class="col-lg-4 col-md-12 col-sm-12">
    <!-- STACKED BAR CHART -->
            <div class="card card-default">
              ...
              <div class="card-body">
              <form method="POST" id="frm_request" enctype="multipart/form-data" action="{{ url('dtr/send-leave-request/test') }}">
              {{ csrf_field() }}
                  ...
                  <strong>Leave Type</strong>
                    ...
                    <p class="text-muted">
                      <select class="form-control" name='leave_id' id='leave_id'>
                        ...
                        <?php
                            $lv = App\Leave_type::whereNotIn('id',[5,4,13,14,15,16])->get();
...
<script>
$('#option-leave-duration,#option-leave-duration3,#option-vl-select,#option-sl-select').hide();
...
function modalOnSubmit()
  ...
  function getLeaveDef(id)
    ...
    $("#userid2").change(function(){
        window.location.replace("{{ url('staff/leave-test/') }}/"+this.value);
    });
</script>
@endsection