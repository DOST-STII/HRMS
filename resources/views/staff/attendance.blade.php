    ...
    <!-- STACKED BAR CHART -->
            <div class="card card-default">
              ...
              <div id="modalprint" class="card-body"> 
                ...
                <table class="table table-bordered" style="font-size: 12px; width: 100%; padding: -1px;">
                  <thead style="text-align: left">
                    <tr>
                        <td colspan="7" align="left">
                        <p class="ft11"  style="text-align: left">Employee Number: {{ Auth::user()->username }} </p>
                        <p class="ft11"  style="text-align: left">Employee Name &#160;: {{ mb_strtoupper(Auth::user()->lname.", ".Auth::user()->fname." ".Auth::user()->mname) }}</p>
                        <p class="ft11"  style="text-align: left">Position &#160; &#160; &#160; :  {{ Auth::user()->position }} </p>
                        <p class="ft11"  style="text-align: left">Group: &#160; &#160; &#160; &#160; &#160;:  {{ $data['division_desc'] }}</p>
                        </td>
                        <td colspan="7" align="left">
                        <p class="ft11">Month/Year &#160; &#160; : {{ date('F',mktime(0, 0, 0, $data['mon'], 10))." ".$data['yr'] }}</p>
