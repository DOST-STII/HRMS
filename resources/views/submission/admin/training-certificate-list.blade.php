        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Training Certificate List</h3><!-- <div class="float-right"><a href="#" class="btn btn-primary" data-toggle="modal" data-target="#modal-request"><i class="fas fa-plus"></i>NEW REQUEST</a></div> -->
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="tbl" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th style="width: 5%" class="text-center">Certificate</th>
                </tr>
                </thead>
                <tbody>
                  @foreach($data['list'] as $lists)
                      <tr>
                        ...
                        <td class="text-center">
                          ...
                          <a href="{{ asset('../storage/app/'.$lists->training_certificate) }}" target="_blank"><i class="fas fa-paperclip"></i></td>
                          @else
                            <b>-</b>
                          @endif
                      </tr>
