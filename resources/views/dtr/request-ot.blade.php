    ...
    <!-- STACKED BAR CHART -->
            <div class="card card-default">
              <div class="card-header">
                <h3 class="card-title"><b>REQUEST FOR OVERTIME</b></h3>
                </form>
                </h3>
...
<script>
  ...
  { 
    ...
    $("#tbl tbody").append("<tr><td><input type='hidden' name='leavedates[]' value='"+strDateTime+"'>"+strDateTime+"</td><td><input type='hidden' name='otdeduc[]' value='"+deduc+"'><input type='hidden' name='otdeductime[]' value='"+deduction+"'>"+deduction+"</td><td><input type='hidden' name='remarks[]' value='"+remarks+"'>"+remarks+"</td><td align='center'><i class='fas fa-times-circle text-danger' style='cursor:pointer' onclick='removeTR(this)'></i></td></tr>");
